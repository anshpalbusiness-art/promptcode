...
export const UninstallCommand = {
  command: "uninstall",
  describe: "uninstall PromptCode and remove all related files",
  builder: (yargs: Argv) =>
    yargs
      .option("keep-config", {
        alias: "c",
        type: "boolean",
        describe: "keep PromptCode configuration files",
        default: false,
      })
      .option("keep-data", {
        alias: "d",
        type: "boolean",
        describe: "keep PromptCode session data and snapshots",
        default: false,
      })
      .option("dry-run", {
        type: "boolean",
  ...
  handler: async (args: UninstallArgs) => {
    ...
    UI.println(banner)
    UI.empty()
    prompts.intro("Uninstall PromptCode")
...
async function executeUninstall(method: Installation.Method, targets: RemovalTargets) {
  ...
  UI.empty()
  prompts.log.success("Thank you for using PromptCode!")
}
